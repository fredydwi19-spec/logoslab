...
export const Layout = ({ children, title, username, role }: { children: string; title: string; username: string; role: string }) => {
  return `
    <!DOCTYPE html>
    <html lang="id">
    <head>
          ...
          <header class="sticky top-0 z-40 bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
              <div class="text-right">
                ...
                <div class="text-[10px] text-slate-500 uppercase">${role.replace('_', ' ')}</div>
              </div>
