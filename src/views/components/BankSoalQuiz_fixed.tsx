              ...
              <template x-for="soal in soalList" :key="soal.id">
                <tr class="hover:bg-slate-50 transition-colors">
                  ...
                  <td class="p-4 text-center align-top space-x-2">
                    <button @click="openFormModal(soal)" class="text-blue-500 hover:text-blue-700" title="Edit">âœï¸</button>
                    <button @click="deleteSoal(soal.id)" class="text-red-500 hover:text-red-700" title="Hapus">ðŸ—‘ï¸</button>
                  </td>
                </tr>
              </template>
            </tbody>
